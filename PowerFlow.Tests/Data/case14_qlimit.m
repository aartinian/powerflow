function mpc = case14_qlimit
%CASE14_QLIMIT  IEEE 14-bus case with a tight Qmax on generator 2.
%   Identical to case14_flatstart.m except gen 2 Qmax = 20 MVAr (was 50).
%   The natural Qg at bus 2 is ~42 MVAr, so the solver must switch bus 2
%   from PV to PQ and fix its reactive injection at the 20 MVAr ceiling.
